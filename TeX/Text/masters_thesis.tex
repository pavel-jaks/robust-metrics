...
Dodejme, že se jedná o součet spojitých funkcí, proto je $H$ sama o sobě spojitá.
...
\begin{lemma} \label{lemma3}
	Funkce záporná k funkci informační entropie, tedy
	\begin{equation}
		f(P) = \sum_{i, j} P_{i, j} \operatorname{log} \left(P_{i, j}\right),
	\end{equation}
	je na $U(\mu, \nu)$ konvexní.
\end{lemma}
...
\begin{theorem}
	...
	a nechť pro všechny indexy $i, j \in \{1, ..., q\}$ platí $\mu_i > 0$ a $\nu_j > 0$. 
	...
	splňuje Slaterovy podmínky regularity pro silnou dualitu.
\end{theorem}
...
\begin{proof}
	...
	A vzhledem ke spojitosti Frobeniova součinu máme i omezenost účelové funkce na kompaktu $U^\alpha(\mu, \nu)$
	(Lemma \ref{lemma1}).
