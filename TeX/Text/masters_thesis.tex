...
Abychom tedy osvětlili toto omezení definičního oboru hledání $P^*$, stačí si uvědomit,
...
Když ještě rozepíšeme Lagrangeovu funkci:
\begin{equation}
...
Pro úlohy strojového učení je potom stěžejní, že je mnohdy lze provádět paralelizovaně.
...
V tomto ouboru je potom samotná implementace metrik vizuální podobnosti.
...
Pro úlohy strojového učení je totiž typické, že je chceme provádět na vícero datech zárověň.
