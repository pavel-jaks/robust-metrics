...
\end{equation}
Jaký je vztah mezi Sinkhornovou metrikou $W^\alpha$ a duální Sinkhornovou metrikou $W^\xi$?
...
tak ve $W^\xi$ figuruje parametr $\xi$ jako Lagrangeův multiplikátor příslušné vazby.
...
dále matici $C$ a regularizační parametr $\xi$.
\begin{enumerate}
    ...
    která vznikne po prvcích jako exponenciála matice $- \xi M$.
